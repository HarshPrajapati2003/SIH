    ...
    try {
      ...
      setTimeout(() => {
        ...
        PlantData.map((plant) => {
          ...
          if (plant["Tulsi"]) console.log(plant["Tulsi"]["Scientific Name"]);
          console.log(plant["Tulsi"]);
        });
        // }
        setShowInfoLoading(false);
      }, 100);
      ...
      <div className="ba-text-content">
        ...
        <div className="file-upload">
          ...
          {file && (
            <div className="file-info">
              ...
              <p>
                {t("services3")}: {file.name}
              </p>
              <div className="button-container">
                <button className="btn btn-success" onClick={handleUpload}>
                  <FontAwesomeIcon icon={faUpload} /> {t("services4")}
                </button>
                <button className="btn btn-danger" onClick={handleRemoveImage}>
                  <FontAwesomeIcon icon={faTrash} /> {t("services5")}
                </button>
              </div>
            </div>
          )}
        ...
        {prediction["category"] && prediction["confidence"] && (
          <p className="ba-checks ba-check-first">
            {/* <GoogleSearch query={prediction["category"]}></GoogleSearch> */}
            <div class="text-center ba-checks">
              ...
              >
                ...
                />
                {t("services6")} : {prediction["category"]}
              </button>
            </div>
            <div class="progress">
              <div
                ...
                aria-valuemin="0"
                aria-valuemax="100"
                style={{ width: `${Math.floor(prediction["confidence"])}%` }}
              >
                {t("services7")} : {prediction["confidence"].toFixed(2)} %
              </div>
            </div>
          </p>
        )}
        ...
        {ShowInfo && (
          <>
            <SolutionStep
              title={t("services8")}
              description={PlantData.map((plant) => {
                if (plant[prediction.category])
                  return plant[prediction.category]["Scientific Name"];
              })}
            />
            ...
            <SolutionStep
              ...
              description={PlantData.map((plant) => {
                if (plant[prediction.category])
                  return plant[prediction.category]["Common Names"];
              })}
            />
            ...
            <SolutionStep
              ...
              description={PlantData.map((plant) => {
                if (plant[prediction.category])
                  return plant[prediction.category]["Description"];
              })}
            />
            <SolutionStep
              title={t("services11")}
              description={PlantData.map((plant) => {
                if (plant[prediction.category])
                  return plant[prediction.category]["Varieties"];
              })}
            />
            <SolutionStep
              title={t("services12")}
              description={PlantData.map((plant) => {
                if (plant[prediction.category])
                  return plant[prediction.category]["Uses"];
              })}
            />
            <SolutionStep
              title={t("services13")}
              description={PlantData.map((plant) => {
                if (plant[prediction.category])
                  return plant[prediction.category]["Medicinal Applications"];
              })}
            />
            <SolutionStep
              title={t("services14")}
              description={PlantData.map((plant) => {
                if (plant[prediction.category])
                  return plant[prediction.category]["Health Benefits"];
              })}
            />
          </>
        )}
